...
Version 1.0.0 is the first stable release of the research artifact for **Better synthetic individuals do not make better synthetic populations**.

## Release identity

- Tag: `v1.0.0`
- Release title: **v1.0.0 — Frozen synthetic-population fidelity research artifact**
- Repository: `abdullah-x-bd/LLM_Persona`
- License for software: MIT
- License for original documentation, figures, and aggregate publication outputs: CC BY 4.0
...
- eight R/ggplot2 publication figures in PDF, SVG, and 600-dpi PNG;
- frozen S01-S05 study registry;
- provenance, scientific-boundary, privacy, and integrity documentation;
...
Original documentation, publication figures, aggregate publication result tables, and derived aggregate summaries are licensed under Creative Commons Attribution 4.0 International in `LICENSE-CONTENT.md`.
